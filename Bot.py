...
def get_order(order_number):
    ...
    if r:
        return {
            'order_number': r[1], 'user_id': r[2], 'user_name': r[3], 'phone': r[4],
            'vin': r[5], 'mileage': r[6], 'style_city': r[7], 'style_highway': r[8],
            'city': r[9], 'distance': r[10], 'delivery_type': r[11], 'delivery_price': r[12],
            'delivery_address': r[13], 'part_node': r[14], 'axle': r[15],
            'needed_parts': r[16], 'selected_products': r[17], 'final_order': r[18],
            'status': r[19], 'status_text': r[20], 'tracking_number': r[21],
            'total_price': r[22], 'our_cost': r[23], 'created_at': r[24]
        }
    return None
