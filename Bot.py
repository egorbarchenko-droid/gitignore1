...
def main():
    ...
    app.add_handler(CommandHandler("fix", lambda u,c: u.message.reply_text("➕ Тестовый заказ доступен через /menu")))
